...
export default function SinglePackage({ match }) {
    ...
    useEffect(() => {
        axios.post('http://localhost/physiosystem/server/client/getSinglePackageTrial', { id: match.params.id }).then(res => {
        ...
        <div className="singlepackage flex fd-column ai-start" >
            ...
            <div className="singlepackage-details flex ai-start">
                <div className="singlepackage-details-left flex">
                    <img src={`http://localhost/physiosystem/server/files/${singlePackage.photo}`} className="img-res" alt="" />
                </div>
            ...
            <div className="singlepackage-demo flex ai-start">
                {singlePackage.videos_demo && singlePackage.videos_demo.map(video => (
                    <div className="singlepackage-demo-item">
                        <video className="img-res" src={`http://localhost/physiosystem/server/files/${video.video_src}`} controls></video>
                    </div>
                ))}
            </div>
