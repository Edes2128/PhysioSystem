        ...
        <div className="fizio-header flex jc-spaceb ai-center" >
            ...
            <div className="fizio-header-widgets flex ai-center">
                <div className="fizio-header-widgets-item flex jc-center ai-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="26" height="25.131" viewBox="0 0 31 30.131">
                        <g id="Group_1172" data-name="Group 1172" transform="translate(1 -1)">
                            <g id="ICON_-_notifications" data-name="ICON - notifications" transform="translate(0 0)">
                                <g id="Vector_Smart_Object" data-name="Vector Smart Object" transform="translate(0 0)">
                                    <path id="Path_25" data-name="Path 25" d="M23.543,10.217a8.217,8.217,0,1,0-16.435,0C7.109,19.8,3,22.543,3,22.543H27.652S23.543,19.8,23.543,10.217Z" transform="translate(-3 0.739)" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" />
